  ...
  <div class="card-body">
    ...
    <div class="catalogos-grid">
      ...
      <div class="catalogos-card">
        ...
        <form class="catalogos-form" method="POST" action="/admin/catalogos/categorias/guardar">
          <input
            type="text"
            name="nombre"
            class="input"
            ...
            <?php foreach ($categorias as $c): ?>
              <tr>
                ...
                <td style="text-align:center;">
                  <form method="POST"
                        action="/admin/catalogos/categorias/cambiar-estado/<?= (int)$c['id'] ?>"
      ...
      <div class="catalogos-card">
        ...
        <form class="catalogos-form" method="POST" action="/admin/catalogos/marcas/guardar">
          <input
            type="text"
            name="nombre"
            class="input"
          ...
          <?php else: ?>
            <?php foreach ($marcas as $m): ?>
              <tr>
                ...
                <td style="text-align:center;">
                  <form method="POST"
                        action="/admin/catalogos/marcas/cambiar-estado/<?= (int)$m['id'] ?>"
                        style="display:inline;">
